        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    <h1 class="display-4 text-white mb-4 animated slideInRight">Erro 403</h1>
                </div>
        ...
        <div class="container text-center py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <h1 class="display-1">Erro 403</h1>
                    <h1 class="mb-4">Acesso Negado</h1>
                    <p class="mb-4">Não tem permissões para aceder a esta página. Se acha que isto é um erro, contacte
                        o
                        administrador.</p>
