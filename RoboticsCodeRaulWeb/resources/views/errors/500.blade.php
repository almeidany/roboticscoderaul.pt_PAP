        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    <h1 class="display-4 text-white mb-4 animated slideInRight">Erro 500</h1>
                </div>
        ...
        <div class="container text-center py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <h1 class="display-1">Erro 500</h1>
                    <h1 class="mb-4">Erro Interno do Servidor</h1>
                    <p class="mb-4">Ocorreu um erro inesperado no servidor. A nossa equipa já foi notificada. Por
