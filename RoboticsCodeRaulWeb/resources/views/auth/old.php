                      ...
                      <div class="form-group col-md-6">
                          <div class="mb-3">
                              ...
                              <input type="text" name="schoolnumber" id="schoolnumber"
                                  ...
                                  value="{{ old('schoolnumber') }}" placeholder="Número de Processo de 5 a 6 digitos"
                                  required>
                              @error('schoolnumber')
                                  <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                      ...
                      <div class="form-group col-md-6">
                          <div class="mb-3">
                              ...
                              <input type="email" name="email" id="email"
                                  ...
                                  placeholder="oseuemail@aerp.pt" required>
                              @error('email')
                                  <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                          </div>
                      ...
                      <div class="form-group col-md-6">
                          <div class="mb-3">
                              ...
                              <input type="text" name="phonenumber" id="phonenumber"
                                  ...
                                  value="{{ old('phonenumber') }}" placeholder="999999999" required>
                              @error('phonenumber')
                                  <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                          </div>
                      ...
                      <div class="form-group col-md-6">
                          <div class="mb-3">
                              ...
                              <input type="text" name="allergies_description"
                                  ...
                                  value="{{ old('allergies_description') }}" placeholder="Amendoins">
                      ...
                      <div class="form-group col-md-6">
                          <div class="mb-3">
                              ...
                              <input type="password" name="password" id="password"
                                  ...
                                  placeholder="Palavra-Passe de 8 digitos" required>
                              @error('password')
                                  <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                          </div>
                      ...
                      <div class="form-group col-md-6">
                          <div class="mb-3">
                              ...
                              <input type="password" name="password_confirmation" class="form-field"
                                  placeholder="Repetir Palavra-Passe" required>
                          </div>
                      </div>
                  </div>
